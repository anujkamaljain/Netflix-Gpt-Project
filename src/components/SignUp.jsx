    ...
    <div className="relative w-full min-h-screen bg-gradient-to-b from-[#0c0303] via-[#30171c] to-[#3b232b]">
      ...
      <div className="relative flex flex-col items-center mt-12 px-4 text-center text-white">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center rounded-lg md:p-6 p-3 md:mt-10 mt-5">
          ...
          <h1 className="text-2xl md:text-4xl md:mt-2 mt-0.5 font-extrabold"> shows, and more </h1>
          <h4 className="lg:text-xl md:text-lg text-xs my-2 ">Starts at ₹149. Cancel at any time.</h4>
      ...
      <div className="px-8 text-white">
        <h2 className=" lg:mt-15 lg:mx-22 md:mt-9 md:mx-10 mt-5 mx-4 md:text-3xl text-lg font-bold md:mb-3">A plan to suit your needs</h2>
      ...
      <div className="px-8 text-white">
        <h2 className="lg:mt-9 md:mt-9 md:mx-13 lg:mx-19 mt-5 mx-4 md:text-4xl text-xl font-bold">More reasons to join</h2>
